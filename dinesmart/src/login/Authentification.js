  ...
  return (
    <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '50px', flexDirection: 'column' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column' }}>
        ...
        <p style={{ textAlign: 'center', marginBottom: '10px', fontFamily: 'Euclid Circular A Light, sans-serif', fontWeight: 'normal' }}>docuMind delivers the answers found in your PDFs that you need, when you need them.</p>
